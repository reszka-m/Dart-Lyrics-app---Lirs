...
class Body {
    ...
    factory Body.fromJson(Map<String, dynamic> json) => Body(
        albumList: List<AlbumList>.from(json["album_list"].map((x) => AlbumList.fromJson(x))),
    );
...
class Album {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "album_release_date": "${albumReleaseDate.year.toString().padLeft(4, '0')}-${albumReleaseDate.month.toString().padLeft(2, '0')}-${albumReleaseDate.day.toString().padLeft(2, '0')}",
        "artist_id": artistId,
